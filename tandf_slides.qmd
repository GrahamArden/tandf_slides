---
title: "Proknow: Automating the process?"
subtitle: "..and why is it not as easy as you (or I) may think"
...
- We _may_ be able to extract the rest of the data from our Record and Verify system (ARIA, Mosaic etc) using a bit of SQL
...
## But this data _may be_ in ARIA (or Mosaic) {.center}
...
## We may also need to find the PTV ROI with the largest dose
...
The source code for the modules should now be available on the T&F group Github page.
...
My own scripts for soritng into collections are on Github
...
These slides are here: https://github.com/GrahamArden/tandf_slides.git
